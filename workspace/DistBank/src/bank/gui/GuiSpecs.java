...
public class GuiSpecs {
	public static final Integer GUI_FRAME_WIDTH = 700; //with
	public static final Integer GUI_FRAME_HEIGHT = 500; //height
	
	// width of snapshot panel
	public static final Integer GUI_SNAPSHOT_WIDTH = (int) (.3 * GuiSpecs.GUI_FRAME_WIDTH); 
