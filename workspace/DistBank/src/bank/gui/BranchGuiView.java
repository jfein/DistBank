...
public class BranchGuiView extends JFrame {
	...
	public BranchGuiView(AppId myAppId) {
		...
		balanceLabel.setPreferredSize(new Dimension(GuiSpecs.GUI_BRANCH_PANEL_WIDTH, 100));
		mainPanel.add(balanceLabel, BorderLayout.SOUTH);

		// Center Panel
		mainButtonPanelLayout = new SpringLayout();
		mainButtonPanel = new JPanel();
		mainButtonPanel.setPreferredSize(new Dimension(GuiSpecs.GUI_BRANCH_PANEL_WIDTH, 280));
		...
		this.srcAccountNumberField = createTextFieldInMainPanel(withdrawButton, GuiSpecs.TEXT_FIELD_OFFSET);
		setLabelNextToField(new JLabel("Source Account Number*:"), this.srcAccountNumberField);

		// Create Destination Account Number Field
		this.destAccountNumberField = createTextFieldInMainPanel(withdrawButton, GuiSpecs.TEXT_FIELD_OFFSET * 2);
		setLabelNextToField(new JLabel("Dest. Account Number:"), this.destAccountNumberField);

		// Create an amount field
		this.amountNumberField = createTextFieldInMainPanel(withdrawButton, GuiSpecs.TEXT_FIELD_OFFSET * 3);
		...
		mainButtonPanelLayout.putConstraint(SpringLayout.NORTH, buttonChoiceLabel, 0, SpringLayout.SOUTH,
				amountNumberField);
		mainButtonPanelLayout.putConstraint(SpringLayout.EAST, buttonChoiceLabel, -96, SpringLayout.EAST,
				mainButtonPanel);
	...
	private void setLabelNextToField(JLabel label, JTextField textField) {
		this.mainButtonPanelLayout.putConstraint(SpringLayout.NORTH, label, 5, SpringLayout.NORTH, textField);
		this.mainButtonPanelLayout.putConstraint(SpringLayout.SOUTH, label, -5, SpringLayout.SOUTH, textField);
		this.mainButtonPanelLayout.putConstraint(SpringLayout.EAST, label, -5, SpringLayout.WEST, textField);
		this.mainButtonPanel.add(label);
	}

	private JTextField createTextFieldInMainPanel(JButton button, Integer northOffset) {
		JTextField textField = new JTextField();
		this.mainButtonPanelLayout.putConstraint(SpringLayout.NORTH, textField, northOffset, SpringLayout.NORTH,
				mainButtonPanel);
		this.mainButtonPanelLayout.putConstraint(SpringLayout.WEST, textField, 0, SpringLayout.WEST, button);
		this.mainButtonPanelLayout.putConstraint(SpringLayout.EAST, textField, 0, SpringLayout.EAST, button);
	...
	public JButton createMenuButton(String name, Integer northOffset) {
		...
		this.mainButtonPanelLayout.putConstraint(SpringLayout.NORTH, button,
				GuiSpecs.MENU_BUTTON_START_N + northOffset, SpringLayout.NORTH, mainButtonPanel);
		this.mainButtonPanelLayout.putConstraint(SpringLayout.EAST, button, -170, SpringLayout.EAST, mainButtonPanel);
