...
public class BankServerRunner {
	...
	public static void main(String[] args) throws IOException {
		...
		if (port == 4001) {
			...
			System.out.println("Withdraw 54.89 from Acnt 111: " + BankClient.withdraw(dest, 111, 54.89, "111.0"));
			System.out.println("Deposit 100 to Acnt 1111:" + BankClient.deposit(dest, 111, 100.00, "111.1"));
			System.out.println("Query 1111: " + BankClient.query(dest, 111, "111.2"));
			System.out.println("Transfer from 1111 to 9: " + BankClient.transfer(dest, 111, 9, 30, "111.3"));
